  ...
  alerts: [
    {
      ...
      sector: 'Roads',
      riskPercentage: 84,
      escalationLevel: 'Level 3: Cabinet Committee',
      timeAgo: '2 hours ago'
    },
    {
      id: 'ALT-202',
    ...
    },
    {
      ...
      sector: 'Railways',
      riskPercentage: 76,
      escalationLevel: 'Level 2: Ministry Nodal Agency',
      timeAgo: '6 hours ago'
    },
    {
      id: 'ALT-204',
      ...
      type: 'critical',
      category: 'delay',
      issue: 'Underground tunneling clearance delayed by heritage commission.',
      tagText: 'Delay Risk',
      state: 'Delhi',
      sector: 'Urban Transport',
      riskPercentage: 79,
    ...
    {
      id: 'ALT-205',
      title: 'Urban Water Supply Scheme',
      type: 'info',
      category: 'progress',
      issue: 'Pipeline network construction is 74% complete.',
